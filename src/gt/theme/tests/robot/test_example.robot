...
#
#  $ bin/test -s gt.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src gt.theme.testing.GT_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/gt/theme/tests/robot/test_example.robot
#
